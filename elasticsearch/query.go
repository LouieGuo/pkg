...
type queryOption struct {
	...
	Highlight            *elastic.Highlight //高亮
	Profile              bool
	EnableDSL            bool     //是否要打印查询语句
	ExcludeFields        []string //查询时不返回哪些字段
	IncludeFields        []string //查询时要包含哪些字段
	SlowQueryMillisecond int64    //查询记录慢日志的时间阈值
	Preference           string
	FetchSource          *bool
}
